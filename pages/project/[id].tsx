...
const IndividualProject = ({ found }: { found: ContentData<ProjectMetaData> }) => {
  ...
  return (
    ...
    <div className="relative w-screen h-auto bg-dark-grey">
      ...
      <div className="px-[7.4vw] font-roboto-mono text-white text-[2.5vh] font-[700] mb-[6vh]">
