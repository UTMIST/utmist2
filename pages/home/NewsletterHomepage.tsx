...
export default function NewsletterHomepage() {
    return (
        <div className="lg:px-[7vw] lg:py-[23vh] sm:py-[13vh] sm:px-[13vw] bg-[#001128] font-roboto-mono">
            <div className="w-full lg:flex flex-row items-center gap-[250px] sm:hidden">
                <div>
                    <div className="w-[550px] h-[92px] text-white text-[30px]">
                        Subscribe to our newsletter
                    </div>
                    <div className="px-[1.6vw]">
                        <form className="flex bg-white w-[540px] h-[50px] mb-[38px]">
