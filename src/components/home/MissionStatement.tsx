...
const MissionStatement: React.FC = () => {
    return (
        <div className="relative flex justify-center items-center w-screen h-[80vh] bg-gradient-to-b from-[#221690] to-[#1A1F6C]">
            {/* Content Box */}
            <div 
                className="p-12 md:p-16 lg:p-20 w-[95%] max-w-6xl flex flex-col md:flex-row items-center md:items-start shadow-lg"
                style={{
            ...
            >
                ...
                <div className="flex-1 text-white text-left">
                    <h2 className="text-3xl md:text-4xl font-semibold font-roboto-mono mb-6">
                        About Us
                    </h2>
                ...
                {/* Logo and Button */}
                <div className="flex flex-col items-center justify-center mt-6 md:mt-0 md:ml-16">
                    <Image 
                    ...
                    <a href={missionData[0].buttonHref}>
                        <button className="bg-[#64C8FA] text-[#1E1E1E] text-lg font-semibold px-8 py-3 rounded-md shadow-md hover:bg-[#4DB2E6] transition">
                            Join Us
                        </button>
                    </a>
                </div>
