        ...
        <div className="w-fit">
          <div className="flex flex-row justify-center mb-[1.5vh]">
            {props.data.socials.LinkedIn != "" ? (
              <div className="bg-linkedin w-[16px] h-[14px] mr-[0.25vw]">
                <a href={props.data.socials.LinkedIn}></a>
              </div>
            ) : null}
            {props.data.socials.GitHub != "" ? (
              <div className="bg-github w-[17px] h-[15px] ml-[0.25vw]">
                <a href={props.data.socials.GitHub}></a>
              </div>
            ) : null}
          </div>
          <div
